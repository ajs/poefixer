...
class Stash(Base):
    ...
    accountName = sqlalchemy.Column(sqlalchemy.String(255))
    lastCharacterName = sqlalchemy.Column(sqlalchemy.String(255))
    stash = sqlalchemy.Column(sqlalchemy.String(255))
    stashType = sqlalchemy.Column(sqlalchemy.String(32), nullable=False)
...
class Item(Base):
    ...
    descrText = sqlalchemy.Column(sqlalchemy.String(255))
    ...
    league = sqlalchemy.Column(sqlalchemy.String(64), nullable=False)
    ...
    note = sqlalchemy.Column(sqlalchemy.String(255))
    properties = sqlalchemy.Column(SemiJSON)
    prophecyDiffText = sqlalchemy.Column(sqlalchemy.String(255))
    prophecyText = sqlalchemy.Column(sqlalchemy.String(255))
